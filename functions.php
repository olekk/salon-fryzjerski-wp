...
function load_stylesheets() {
    ...
    wp_register_style('mystyles', get_template_directory_uri() . '/style.css', array(), 1, 'all');
    wp_enqueue_style('mystyles');
    

    wp_register_style('flickity', get_template_directory_uri() . '/css/flickity.min.css', array(), 1, 'all');
...
global $dane;
$dane = array(
    'adres' => 'AB-XYZ Twój Adres',
    'tel1' => '123 456 789',
    'tel2' => '123 456 987',
    'email' => 'twoj@mail.com',
    'nazwa' => 'Nazwa Twojego Salonu',
    'fblink' => '#',
    'instalink' => '#'
);
